  ...
  return (
    <div className="home">
      ...
      <div className="accommodationList">
        <h2>Accommodation</h2>
        {holiday &&
          holiday.accommodationList.map((accommodation) => (
      ...
      <div className="activityList">
        <h2>Activity</h2>
        {holiday &&
          holiday.activityList.map((activity) => (
